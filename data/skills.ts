...
export const skills: Skill[] = [
  ...
  { name: 'Next.js', category: 'frontend', proficiency: 85, icon: 'nextjs', color: 'bg-gray-800' },
  ...
  { name: 'Vue.js', category: 'frontend', proficiency: 70, icon: 'vue', color: 'bg-green-500' },
  ...
  { name: 'Python', category: 'backend', proficiency: 75, icon: 'python', color: 'bg-yellow-600' },
  ...
  { name: 'AWS', category: 'devops', proficiency: 60, icon: 'aws', color: 'bg-orange-500' },
  { name: 'Vercel', category: 'devops', proficiency: 85, icon: 'vercel', color: 'bg-black' },
